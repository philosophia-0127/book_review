...
<div id="profile-edit-form" class="container">
    ...
    <div class="row">
        <div class="col-8 offset-2 bg-white">
            ...
            <form method="POST" action="{{ route('user.show') }}" class="p-5" enctype="multipart/form-data">
                @csrf

                <span class="avatar-form image-picker">
                    <input type="file" name="avatar" class="d-none" accept="image/png,image/jpeg,image/gif" id="avatar" />
                    <label for="avatar" class="d-inline-block">
                        <img src="/images/no_image.jpg" class="rounded-circle" style="object-fit: cover; width: 200px; height: 200px;">
                    </label>
                </span>
